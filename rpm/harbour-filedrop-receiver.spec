...
Name:       harbour-filedrop-receiver
...
Source100:  harbour-filedrop-receiver.yaml
...
%files test
%defattr(-,root,root,-)
%{_bindir}/tst-harbour-postbox
%{_datadir}/tst-harbour-postbox/*.qml
%{_datadir}/tst-harbour-postbox/*.sh
%attr(0755,-,-) %{_datadir}/tst-harbour-postbox/*.sh
# >> files test
# << files test
